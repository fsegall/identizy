...
const translations = {
  en: {
    ...
    'demo.watchRecording': 'Watch the full product walkthrough',
    'demo.recordingSubtitle': 'ZK proof → on-chain credential → Soulbound NFT — live on Stellar mainnet',
    'demo.openRecording': 'Open recording',
    'demo.credentialTx': 'Credential tx on Stellar Explorer',
    'demo.nftTx': 'NFT mint tx on Stellar Explorer',
    'demo.teaserLabel': 'Teaser',
  ...
  pt: {
    ...
    'demo.videoLabel': 'Demo do Produto',
    'demo.watchRecording': 'Assista ao walkthrough completo do produto',
    'demo.recordingSubtitle': 'Prova ZK → credencial on-chain → Soulbound NFT — ao vivo na mainnet Stellar',
    'demo.openRecording': 'Abrir gravação',
    'demo.credentialTx': 'Tx da credencial no Stellar Explorer',
    'demo.nftTx': 'Tx do mint NFT no Stellar Explorer',
    'demo.teaserLabel': 'Teaser',
